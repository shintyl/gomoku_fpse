...
module Board = struct
  ...
  (*
    Attempt to insert a piece onto the board. Return Error if attempt fails.
  *)
  ...
  (*
    Find longest contiguous ray from a given position and in a given direction
  *)
  ...
  (*
    Find longest contiguous line from a given position and in a given direction.
  *)
  ...
  (*
    Check if inserting a piece at a position yields victory.
  *)
